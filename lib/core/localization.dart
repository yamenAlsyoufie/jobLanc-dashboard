...
class localization extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          "70": "Active",
          "71": "In-active",
          "72": "The tag has been added to skills",
          "73": "Couldn't add tag to skills",
          "74": "Tags",
          "75": "Reports",
          "76":"Companies this month",
        ...
        'ar': {
          ...
          '13': 'صفحة الاعدادات',
          '14':
              'إعادة تعيين كلمة المرور إذا نسيتها، وتحكم في الوضع المظلم أو الفاتح وإدارة التقارير وإدارتها',
          //Login Page
